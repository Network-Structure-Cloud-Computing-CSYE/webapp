...
router.post('/demo/assignments', authenticate, async (req, res) => {
    try {
...
router.post('/demo/assignments/:assignmentId/submission', authenticate, async (req, res) => {
...
router.put('/demo/assignments/:id', authenticate, async (req, res) => {
    try {
        const { name, points, num_of_attempts, deadline } = req.body;
...
router.delete('/demo/assignments/:id', authenticate, async (req, res) => {
    try {
        const assignment = await Assignment.findOne({
            where: {
                assignmentId: req.params.id,
...
router.get('/demo/assignments', authenticate, async (req, res) => {
    try {
...
router.get('/demo/assignments/:id', authenticate, async (req, res) => {
    try {
